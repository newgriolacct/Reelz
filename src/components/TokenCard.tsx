...
export const TokenCard = ({ token, onLike, onComment, onBookmark }: TokenCardProps) => {
  ...
  return (
    <>
      <div className="h-screen snap-start relative flex flex-col bg-background pt-[100px]">
        {/* Token Header */}
        <div className="px-3 pt-2 pb-1.5 flex items-center justify-between bg-background">
        ...
        {/* Bottom - Token Info */}
        <div className="relative px-3 pt-3 pb-20 flex flex-col justify-between bg-background" style={{ minHeight: '45vh' }}>
          {/* Price Info */}
          <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="bg-secondary rounded-lg p-2">
              <div className="text-[10px] text-muted-foreground mb-0.5">Chain</div>
              <div className="text-sm font-bold text-foreground truncate">
                {token.chain}
              </div>
            </div>
