...
export const NetworkSelector = () => {
  ...
  return (
    <div className="fixed top-[52px] md:top-16 left-0 right-0 z-40 bg-card/95 backdrop-blur-sm border-b border-border">
      <div className="flex gap-1 md:gap-1 p-1.5 md:p-2 overflow-x-auto scrollbar-hide">
        {networks.map((network) => {
          ...
          return (
            <button
              ...
              className={`flex-shrink-0 flex items-center gap-1.5 px-3 md:px-4 py-1.5 md:py-2 rounded-md md:rounded-lg text-xs md:text-sm font-medium whitespace-nowrap transition-all ${
